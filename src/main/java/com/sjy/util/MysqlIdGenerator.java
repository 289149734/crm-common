...
public class MysqlIdGenerator implements IdentifierGenerator, Configurable {
	...
	public Serializable generate(SessionImplementor session, Object obj) throws HibernateException {
		...
		NamedSQLQueryDefinition ns = new NamedSQLQueryDefinition(seqName, query, queryReturns, new ArrayList(), false,
				"", 30000, 1, FlushMode.AUTO, CacheMode.NORMAL, true, "", new HashMap(), false);
		...
		ns = new NamedSQLQueryDefinition(seqName, update, queryReturns, new ArrayList(), false, "", 30000, 1,
				FlushMode.AUTO, CacheMode.NORMAL, true, "", new HashMap(), false);
